import { constructLink } from "../../src/lib/helpers";
...
describe('extractLink', () => {
  ...
  test('should return the link when some other words are added', () => {
    // Act
    const result = constructLink('global https:// some https inserted before link' + link + ' you can visit this website for further assistance')
  ...
  test('should return empty string if no link is found', () => {
    // Act
    const result = constructLink('global wwww some broken link you can visit test.diet this website for further assistance');
    const expected = false;
  ...
  test('should extract link with https://', () => {
    // Act
    const result = constructLink('global wwww some broken link you can visit https://test.diet this website for furtger assistance');
  ...
  test('should extract link with http://', () => {
    // Act
    const result = constructLink('global wwww some broken link you can visit http://test.diet this website for furtger assistance');
  ...
  test('should extract link with www', () => {
    // Act
    const result = constructLink('global wwww healthy link you can visit www.test.diet this website for further assistance');
